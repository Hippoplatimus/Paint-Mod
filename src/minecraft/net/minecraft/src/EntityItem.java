// This file was modified to allow paintbrushes to be rinsed off in water blocks
...
public class EntityItem extends Entity
{
    ...
    {
    	if (isInWater() && ItemPaintbrush.isPaintbrush(item.itemID)) {
    		item = ItemPaintbrush.getWashedBrush(item);
    	}
